...
_carbine_mag = "30Rnd_65x39_caseless_green";
_carbine_mag_tr = "30Rnd_65x39_caseless_green_mag_Tracer";

// UGL Rifle
_glrifle = "arifle_Katiba_GL_F";
_glrifle_mag = "30Rnd_65x39_caseless_green";
_glrifle_mag_tr = "30Rnd_65x39_caseless_green_mag_Tracer";
...
_rifleSilencer = "muzzle_snds_H"; // for the m16/m4 pack
...
// select optics
_scope_r = "optic_MRCO";  // rifleman optic
...
// Backpacks
_bag_small = "B_AssaultPack_ocamo";				// carries 120, weighs 20
_bag_medium = "B_FieldPack_ocamo";				// carries 240, weighs 30
_bag_large =  "B_Carryall_ocamo"; 				// carries 320, weighs 40
_bag_diver =  "B_AssaultPack_blk";				// used by divers
_bag_uav = "O_UAV_01_backpack_F";				// used by UAV operator
_bag_hmg_G = "O_HMG_01_weapon_F";				// used by Heavy MG gunner
_bag_hmg_AG = "O_HMG_01_support_F";				// used by Heavy MG assistant gunner
_bag_hat_G = "O_AT_01_weapon_F";				// used by Heavy AT gunner
_bag_hat_AG = "O_HMG_01_support_F";				// used by Heavy AT assistant gunner
_bag_mtr_G = "O_Mortar_01_weapon_F";			// used by Mortar gunner
_bag_mtr_AG = "O_Mortar_01_support_F";			// used by Mortar assistant gunner
_bag_hsam_G = "O_AA_01_weapon_F";				// used by Heavy SAM gunner
_bag_hsam_AG = "O_HMG_01_support_F";			// used by Heavy SAM assistant gunner
