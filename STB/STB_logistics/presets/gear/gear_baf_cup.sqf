...
// select optics
_scope_r = "RKSL_optic_LDS";  // rifleman optic
_scope_mg = "RKSL_optic_LDS"; // MG gunner optic
_scope_tl = "RKSL_optic_LDS"; // section/team leader optic
...
_scope_dmr = "RKSL_optic_PMII_312_sunshade"; // mid-long range optic (marksmen)
_scope_co = "RKSL_optic_LDS"; // commander's optics

// array of extra optics that will be added to backpack to give players a choice
_spareOptics = ["CUP_optic_ACOG"];
...
_bag_medium = "B_AssaultPack_mcamo";				// carries 240, weighs 30
