/*
	LOADOUT PRESET:	NATO VANILLA
	
	Dependencies: NONE
*/

/*
	PRIMARY WEAPONS (EDIT FROM HERE)
*/

// Assualt Rifle
_rifle = "CUP_srifle_LeeEnfield";
_rifle_mag = "CUP_10x_303_M";
_rifle_mag_tr = "CUP_10x_303_M";
...
_carbine_mag_tr = "CUP_10x_303_M";

// UGL Rifle
_glrifle = "arifle_Mk20_GL_F";
_glrifle_mag = "30Rnd_556x45_Stanag";
_glrifle_mag_tr = "CUP_10x_303_M";
...
// Light MG
_ar = "CUP_arifle_M16A2";
_ar_mag = "30Rnd_556x45_Stanag";
_ar_mag_tr = "30Rnd_556x45_Stanag_Tracer_Red";

// Medium MG
_mmg = "CUP_arifle_M16A2";
_mmg_mag = "30Rnd_556x45_Stanag";
_mmg_mag_tr = "30Rnd_556x45_Stanag_Tracer_Red";

// Designated Marksman
_dmr = "CUP_srifle_CZ550";
_dmr_mag = "CUP_5x_22_LR_17_HMR_M";
...
// Sidearm
_pistol = "CUP_hgun_MicroUzi";
_pistol_mag = "CUP_30Rnd_9x19_UZI";

// Light AT
_lat = "CUP_launch_RPG7V";
_lat_mag = "CUP_PG7V_M";
