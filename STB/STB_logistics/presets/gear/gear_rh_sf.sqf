/*
	...
	Dependancies: Robert-Hammer M4/M16 pack / Massi's NATO SF Weapons Pack
*/
...
// Light MG
_ar = "LMG_mas_m249a_F";
_ar_mag = "CUP_200Rnd_TE4_Red_Tracer_556x45_L110A1";
_ar_mag_tr = "CUP_200Rnd_TE4_Red_Tracer_556x45_L110A1";
...
// Designated Marksman
_dmr = "RH_SR25EC";
_dmr_mag = "RH_20Rnd_762x51_Mk319";
...
_flashlight = "RH_SFM952V";	// Flashlight

// select silencers appropriate to the caliber of your chosen weapon set
_rifleSilencer = "RH_fa556"; // for the m16/m4 pack
_silencerAR = "RH_fa556";	// m249 silencer
_silencerMMG = "RH_fa556";
_silencerDMR = "RH_fa762";	// dmr silencer
_handgunSilencer = "muzzle_snds_L"; // .45 ACP

// select optics
_scope_r = "RH_eotech553mag";  // rifleman optic
_scope_mg = "RH_eotech553mag"; // MG gunner optic
_scope_tl = "RH_eotech553mag"; // section/team leader optic
_scope_sf = "RH_eotech553mag"; // special forces optic (short range)
_scope_lr = "RH_eotech553mag"; // long-range optic (snipers)
_scope_dmr = "RH_accupoint"; // mid-long range optic (marksmen)
_scope_co = "RH_eotech553mag"; // commander's optics

// array of extra optics that will be added to backpack to give players a choice
_spareOptics = ["RH_ta31rmr"];
...
// Backpacks
_bag_small = "B_mas_Kitbag_black";					// carries 120, weighs 20
