...
// Assualt Rifle
_rifle = "CUP_arifle_FNFAL";
_rifle_mag = "CUP_20Rnd_762x51_FNFAL_M";
_rifle_mag_tr = "CUP_20Rnd_762x51_FNFAL_M";
...
_scope_tl = "CUP_optic_ACOG"; // section/team leader optic
...
_scope_co = "CUP_optic_ACOG"; // commander's optics
...
/*
	EXTRAS (an array of other shit that will go into every unit's inventory)
*/
