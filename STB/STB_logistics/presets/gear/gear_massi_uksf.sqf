...
// Light MG
_ar = "CUP_lmg_Mk48_wdl";
_ar_mag = "CUP_100Rnd_TE4_LRT4_Red_Tracer_762x51_Belt_M";
_ar_mag_tr = "CUP_100Rnd_TE4_LRT4_White_Tracer_762x51_Belt_M";

// Medium MG
_mmg = "CUP_lmg_Mk48_wdl";
_mmg_mag = "CUP_100Rnd_TE4_LRT4_Red_Tracer_762x51_Belt_M";
_mmg_mag_tr = "CUP_100Rnd_TE4_LRT4_White_Tracer_762x51_Belt_M";

// Designated Marksman
_dmr = "srifle_mas_sr25_v";
_dmr_mag = "20Rnd_mas_762x51_Stanag";
...
_irPointer = "acc_mas_pointer_IR2c_top";	// IR Laser
_flashlight = "acc_flashlight";	// Flashlight

// select silencers appropriate to the caliber of your chosen weapon set
_rifleSilencer = "muzzle_mas_snds_Mc"; 	// 
_silencerAR = "muzzle_snds_H_MG";	// m249 silencer
_silencerMMG = "muzzle_snds_B";
_silencerDMR = "muzzle_mas_snds_SMc";		// dmr silencer
_handgunSilencer = "muzzle_snds_acp"; // .45 ACP

// select optics
_scope_r = "optic_mas_Holosight_camo";  // rifleman optic
_scope_mg = "optic_mas_Holosight_camo"; // MG gunner optic
_scope_tl = "optic_mas_MRCO_camo"; // section/team leader optic
_scope_sf = "optic_aco"; // special forces optic (short range)
_scope_lr = "optic_SOS"; // long-range optic (snipers)
_scope_dmr = "optic_mas_zeiss_c"; // mid-long range optic (marksmen)
_scope_co = "optic_mas_Hamr_camo"; // commander's optics

// array of extra optics that will be added to backpack to give players a choice
_spareOptics = ["optic_mas_acog_rd_c"];
...
_bag_medium = "B_FieldPack_blk";				// carries 240, weighs 30
